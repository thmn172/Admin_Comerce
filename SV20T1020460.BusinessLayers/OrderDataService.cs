...
namespace SV20T1020460.BusinessLayers
{
    public static class OrderDataService
    {
        ...
        public static int InitOrder(int employeeID, int customerID,
                                    string deliveryProvince, string deliveryAddress, IEnumerable<OrderDetail> details)
        {
            if (details.Count() == 0)
                return 0;
        ...
        public static bool EditDelivery(Order data)
        {
            return orderDB.EditDelivery(data);
        }
